...
<body>
<form action="<?php echo base_url(); ?>request/kaigisho-dt/order_y/input" method="post" id="ordery_input">
  ...
  <tr>
    ...
    <table width="100%" border="1" cellspacing="0" cellpadding="5">
      ...
      <tr>
        ...
        <td><font color="#33cc15">「Yコース」●初15,000円／月3,000円</font>
        <input name="plan_name" type="hidden" size="40" value="「Yコース」●初15,000円／月3,000円" />
        </td>
      </tr>
      <tr>
        <td width="20%" class="col3">ディスク容量</td>
        <td>25GB
        <input name="disk_space" type="hidden" size="40" value="25GB" />
        </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>1.5GB <input name="max_memory" type="hidden" size="40" value="1.5GB" /></td>
      </tr>
      <tr>
        <td width="20%" class="col3">プロセス数上限</td>
        <td>512 <input name="limit_memory" type="hidden" size="40" value="512" /></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>1個 <input name="IP_address" type="hidden" size="40" value="1個" /></td>
      </tr>
      <tr>
