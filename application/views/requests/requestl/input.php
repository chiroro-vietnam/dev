  ...
  <tr>
    ...
    <table width="100%" border="1" cellspacing="0" cellpadding="5">
      ...
      <tr>
        ...
        <input name="plan_name" type="hidden" size="40" value="「Lコース」●初15,000円／月2,200円" />
        </td>
      </tr>
      <tr>
        <td width="20%" class="col3">ディスク容量</td>
        <td>15GB
        <input name="disk_space" type="hidden" size="40" value="15GB" />
        </td>
      </tr>
      <tr>
        <td width="20%" class="col3">保証メモリ</td>
        <td>256MB
        <input name="guarantee_memory" type="hidden" size="40" value="256MB" />
        </td>
      </tr>
      <tr>
        <td width="20%" class="col3">最大メモリ</td>
        <td>384MB <input name="max_memory" type="hidden" size="40" value="384MB" /></td>
      </tr>
      <tr>
        <td width="20%" class="col3">プロセス数上限</td>
        <td>384 <input name="limit_memory" type="hidden" size="40" value="384" /></td>
      </tr>
      <tr>
        <td width="20%" class="col3">管理ツール</td>
        <td>Webmin <input name="manager" type="hidden" size="40" value="Webmin" /></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>利用不可
          <input name="ssl" type="hidden" size="40" value="利用不可" />
        </td>
      </tr>
      <tr>
    ...
    <tr>
      ...
      <tr>
        ...
        <td>利用不可 <input name="mysql" type="hidden" size="40" value="MySQL" /></td>
      </tr>
      <tr>
        <td width="20%" class="col3">PostgreSQL</td>
        <td>利用不可 <input name="postgresql" type="hidden" size="40" value="利用不可" /></td>
      </tr>
      <tr>
